package com.chalilayang.voicechange;
...
import com.chalilayang.voicechanger.PlayerListener;
import com.chalilayang.voicechanger.PlayerManager;
import com.chalilayang.voicechanger.RecorderListener;
import com.chalilayang.voicechanger.RecorderManager;
import com.chalilayang.voicechanger.VoiceChanger;

public class MainActivity extends AppCompatActivity  implements RecorderListener, PlayerListener {
    ...
    public void onClickRecord(View view) {
        ...
        if (!mRecorderManager.isRecording()) {
            mVoiceChanger.setPitch(4);
            mVoiceChanger.setTempo(1f);
