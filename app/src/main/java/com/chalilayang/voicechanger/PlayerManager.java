package com.chalilayang.voicechanger;
...
import com.chalilayang.speex.SpeexPlayer;
import com.chalilayang.speex.SpeexPlayerListener;
...
public class PlayerManager {
     ...
     *
     * @param activity 需要监听距离的Acitivity
     */
     ...
     * @param isForceStart 是否强制开始。当当前正在播放音频时，若为true则先停止之前的播放，若为false则不停止之前的播放并且放弃这次播放。
     */
